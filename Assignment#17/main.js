...
console.log("\n*************************************");
console.log("Unfortunately! Our new dinner table won\u2019t arrive in time for the dinner, and we have space for only two guests. ");
console.log("*************************************\n");
// invite two persons to the dinner.
